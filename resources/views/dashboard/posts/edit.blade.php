...
<form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" required autofocus value="{{ old('title', $post->title), $post->title }}">
      @error('title')
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="slug" name="slug" required value="{{ old('slug', $post->slug), $post->slug }}">
        @error('slug')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
